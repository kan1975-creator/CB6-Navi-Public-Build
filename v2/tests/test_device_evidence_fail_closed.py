...
def run_case(name,mutate,needle):
 with tempfile.TemporaryDirectory() as td:
  ...
  dev={"schema":1,"feature_id":"testfeature","build_commit":head,"apk_evidence":apk_rel,"apk_sha256":sha,"device":"CB6","android_version":"13","checks":[{"id":"signal-render","result":"PASS","evidence":"observed on CB6"}],"status":"ACCEPTED"}
